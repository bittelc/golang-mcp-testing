...
type ExecuteCommandArgs struct {
	...
	Shell     *string `json:"shell,omitempty" description:"Optional shell to use (e.g., /bin/bash, cmd.exe). Defaults to best available shell."`
}
